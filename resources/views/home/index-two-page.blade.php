...
<body>
    ...
    <section class="intro-section">
        <div class="intro-container-wrapper style2 section-padding pt-0">
            <div class="intro-wrapper style2" data-bg-src="assets/images/bg/introBg2_1.png">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="intro-content">
                                <div class="intro-section-title">
                                    <div class="intro-subtitle wow fadeInUp" data-wow-delay=".4s">
                                        <span>News!</span>Find Your Solution <img src="assets/images/icon/fireIcon.svg"
                                            alt="icon">
                                    </div>
            ...
            <div class="thumb-box">
                <div class="main-thumb">
                    <img class="img-custom-anim-left wow fadeInUp" data-wow-delay=".2s"
                        src="assets/images/intro/introThumb2_1.png" alt="thumb">
                    <div class="thumb1 float-bob-y">
                        <img src="assets/images/intro/introThumb2_2.png" alt="thumb">
                    </div>
                    <div class="thumb2 float-bob-x">
                        <img src="assets/images/intro/introThumb2_3.png" alt="thumb">
                    </div>
                </div>
                                ...
                                <div class="about-content">
                                    <div class="section-title">
                                        <div class="subtitle wow fadeInUp" data-wow-delay=".2s">
                                            About Us<img src="assets/images/icon/fireIcon.svg" alt="icon">
                                        </div>
                            ...
                            <div class="col-xl-6 order-1 order-xl-2">
                                <div class="about-thumb">
                                    <img class="img-custom-anim-left wow fadeInUp" data-wow-delay=".4s"
                                        src="assets/images/about/aboutThumb2_1.png" alt="thumb">
    ...
    <section class="wp-section section-padding fix">
        <div class="container">
            <div class="wp-wrapper style2">
                <div class="shape"> <img src="assets/images/shape/wpShape2_1.png" alt="shape"> </div>
        ...
        <div class="testimonial-container-wrapper style2">
            <div class="container">
                <div class="testimonial-wrapper style2 fix">
                    <div class="shape1"><img src="assets/images/shape/testimonialShape2_1.png" alt="shape"></div>
                    <div class="shape2"><img src="assets/images/shape/testimonialShape2_2.png" alt="shape"></div>
                    <div class="container">
                ...
                <div class="row gy-5">
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-card style2 wow fadeInLeft" data-wow-delay=".3s">
                            <div class="blog-card-thumb  img-shine">
                                <img src="assets/images/blog/blogThumb2_1.jpg" alt="thumb">
                            </div>
                            <div class="blog-card-body">
                                ...
                                <h3 class="blog-title">
                                    <a href="blog-details.html">Tackling the Changes of Retail Industry</a>
                                </h3>
                                <div class="btn-wrapper">
                                    <a href="blog-details.html">Read More <img
                                            src="assets/images/icon/arrowIconDark.svg" alt="icon"></a>
                                </div>
                                <div class="calendar">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-card style2 wow fadeInRight" data-wow-delay=".5s">
                            <div class="blog-card-thumb  img-shine">
                                <img src="assets/images/blog/blogThumb2_2.jpg" alt="thumb">
                            </div>
                            <div class="blog-card-body">
                                <div class="tag-cloud">
                                    <div class="meta">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-card style2 wow fadeInUp" data-wow-delay=".7s">
                            <div class="blog-card-thumb  img-shine">
                                <img src="assets/images/blog/blogThumb2_3.jpg" alt="thumb">
                            </div>
                            <div class="blog-card-body">
                                <div class="tag-cloud">
                                    <div class="meta">

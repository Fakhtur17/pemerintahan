...
<body>
    ...
    <section class="pricing-section-3 section-padding fix" style="background-image: url('assets/images/pricing-bg.jpg');" id="pricing">
        <div class="container">
    ...
    <section class="testimonial-section-3 section-padding fix section-padding bg-cover" id="testimonial" style="background-image: url('assets/images/testimoial/bg.jpg');">
        <div class="container">

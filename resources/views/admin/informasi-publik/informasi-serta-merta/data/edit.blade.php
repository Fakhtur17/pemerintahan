...
<div class="container-fluid py-4">
    ...
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-body">
            ...
            <form action="{{ route(
                'admin.informasi-publik.informasi-serta-merta.data.update',
                [
                ...
                <div class="mb-4">
                    ...
                    <input type="text"
                        ...
                        value="{{ $jenisInformasiSertaMerta->nama_jenis }}"
                        readonly>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date"
                            ...
                            value="{{ old(
                                   'tanggal_upload',
                                   $dataInformasiSertaMerta->tanggal_upload
                                       ->format('Y-m-d')
                               ) }}"
                            required>
                            ...
                            <div class="border rounded p-3">
                                ...
                                <div class="form-check">
                                    ...
                                    <input type="radio"
                                        ...
                                        id="tipeLink"
                                        class="form-check-input"
                                        {{ $dataInformasiSertaMerta->tipe_dokumen === 'link'
                                               ? 'checked'
                                               : '' }}>
                ...
                <div class="mb-3"
                    ...
                    <input type="url"
                        ...
                        value="{{ old(
                               'link_url',
                               $dataInformasiSertaMerta->link_url
                           ) }}"
                        placeholder="https://...">

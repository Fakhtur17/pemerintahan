...
@section('title', 'Beranda 3 | Niotech')
@section('meta_description', 'Beranda 3 | Niotech')
...
<!-- Hero Section S T A R T -->
    ...
    <section class="pricing-section-3 section-padding fix" style="background-image: url('{{ asset('assets/images/pricing-bg.jpg') }}');">
        <div class="container">
    ...
    <section class="testimonial-section-3 section-padding fix section-padding bg-cover" style="background-image: url('{{ asset('assets/images/testimoial/bg.jpg') }}');">
        <div class="container">

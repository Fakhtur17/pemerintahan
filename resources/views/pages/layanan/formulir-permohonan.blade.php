...
@section('title', 'Detail Blog | Niotech')
@section('meta_description', 'Detail Blog | Niotech')
            ...
            <div class="container">
                ...
                <div class="breadcumb-wrapper">
                    <div class="page-heading">
                        <h1>Blog Details</h1>
                        <div class="links">
                            <a href="{{ route('home') }}">Home<span class="slash">/</span></a>Blog Details
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row tag-share-wrap mt-4 mb-30 wow fadeInUp" data-wow-delay=".8s">
                                <div class="col-lg-8 col-12">
                                    <div class="tagcloud">
                                        ...
                                        <a href="{{ route('blog.show') }}">News</a>
                                        <a href="{{ route('blog.show') }}">business</a>
                                        <a href="{{ route('blog.show') }}">marketing</a>
                                    </div>
                                </div>
                                ...
                                <div class="blog-single-comment d-flex gap-4 pt-30 pb-30">
                                    ...
                                    <div class="content">
                                        <div
                                            ...
                                            <div class="con">
                                                <h5><a href="{{ route('blog.show') }}">Albert Flores</a></h5>
                                                <span>March 20, 2024 at 2:37 pm</span>
                                            </div>
                                            <div class="btn">
                                                <a href="{{ route('blog.show') }}" class="reply">Reply</a>
                                            </div>
                                        </div>
                                ...
                                <div class="blog-single-comment d-flex gap-4 pt-30 pb-30">
                                    ...
                                    <div class="content">
                                        <div
                                            class="head d-flex flex-wrap gap-2 align-items-center justify-content-between">
                                            <div class="con">
                                                <h5><a href="{{ route('blog.show') }}">Alex Flores</a></h5>
                                                <span>March 20, 2024 at 2:37 pm</span>
                                            </div>
                                            <div class="btn">
                                                <a href="{{ route('blog.show') }}" class="reply">Reply</a>
                            ...
                            <div class="single-sidebar-widget wow fadeInUp" data-wow-delay=".4s">
                                ...
                                <div class="news-widget-categories">
                                    <ul>
                                        ...
                                        <li class="active"><a href="{{ route('blog.show') }}">App Development
                                                <span>(12)</span></a></li>
